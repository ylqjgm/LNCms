...
- [功能描述](#功能描述)
  ...
  - [4. 权限管理](#4-权限管理)
    ...
    - [4.2 用户组管理](#42-用户组管理)
    - [4.3 等级管理](#43-等级管理)
    - [4.4 作者类型管理](#44-作者类型管理)
    - [4.5 作者等级管理](#45-作者等级管理)
    - [4.6 权限管理](#46-权限管理)
  - [5. 用户管理](#5-用户管理)
  - [6. 作者管理](#6-作者管理)
  - [7. 内容管理](#7-内容管理)
    ...
    - [7.3 标签管理](#73-标签管理)
    - [7.4 小说管理](#74-小说管理)
      - [7.4.1 小说信息管理](#741-小说信息管理)
      - [7.4.2 小说分卷管理](#742-小说分卷管理)
      - [7.4.3 小说章节管理](#743-小说章节管理)
      - [7.4.4 小说章节附件管理](#744-小说章节附件管理)
    - [7.5 漫画管理](#75-漫画管理)
      - [7.5.1 漫画信息管理](#751-漫画信息管理)
      - [7.5.2 漫画章节管理](#752-漫画章节管理)
      - [7.5.3 漫画章节图片管理](#753-漫画章节图片管理)
    - [7.6 音频管理](#76-音频管理)
      - [7.6.1 音频信息管理](#761-音频信息管理)
      - [7.6.2 音频分季管理](#762-音频分季管理)
      - [7.6.3 音频分集管理](#763-音频分集管理)
      - [7.6.4 音频文件管理](#764-音频文件管理)
    - [7.7 视频管理](#77-视频管理)
      - [7.7.1 视频信息管理](#771-视频信息管理)
      - [7.7.2 视频分季管理](#772-视频分季管理)
      - [7.7.3 视频分集管理](#773-视频分集管理)
      - [7.7.4 视频文件管理](#774-视频文件管理)
  - [8. 消费管理](#8-消费管理)
    - [8.1 渠道管理](#81-渠道管理)
    - [8.2 虚拟物品管理](#82-虚拟物品管理)
    - [8.3 票务管理](#83-票务管理)
    - [8.4 退费管理](#84-退费管理)
    - [8.5 流水管理](#85-流水管理)
    - [8.6 作者收益管理](#86-作者收益管理)
  - [9. 互动管理](#9-互动管理)
    - [9.1 评论管理](#91-评论管理)
      - [9.1.1 小说评论](#911-小说评论)
      - [9.1.2 漫画评论](#912-漫画评论)
  ...
  - [11. 备份恢复](#11-备份恢复)
    - [11.1 备份管理](#111-备份管理)
      - [11.1.1 备份渠道](#1111-备份渠道)
      - [11.1.2 自动备份](#1112-自动备份)
    - [11.2 恢复管理](#112-恢复管理)
...
对网站作者类型进行管理。作者类型用于标识作者可以创作的内容类型。

- 类型代码（如：novel、comic、audio、video）
- 类型名称（如：小说作者、漫画作者、音频作者、视频作者）
- 类型描述
- 显示顺序
